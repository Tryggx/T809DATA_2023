...
def get_titanic():
    ...
    # DO NOT REMOVE
    if os.path.exists('./T809DATA_2023/08_boosting/data/train.csv'):
        train = pd.read_csv('./T809DATA_2023/08_boosting/data/train.csv')
        test = pd.read_csv('./T809DATA_2023/08_boosting/data/test.csv')
    else:
